...
{
    execute(name,[command],false,callback);
};
...
{
    execute(name,commands,true,callback);
};
 ...
 * @param callback 回调
 */
var execute = function(name,commands,istrans,callback)
{
 ...
 * @param value 值
 */
exports.redisSet = function(name,key,value,callback)
{
    exeConnection.getRedisClient(name).set(key,value,callback);
};
